...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"../node_modules/react-transition-group/esm/CSSTransition.js":[function(require,module,exports) {
"use strict";
...
function Detail(_ref) {
  var detailQuan = _ref.detailQuan,
      onQuan_Initialize = _ref.onQuan_Initialize,
      onIncrease = _ref.onIncrease,
      onDecrease = _ref.onDecrease,
      onAddData = _ref.onAddData,
  ...
  var _useState3 = (0, _react.useState)(false),
      ...
      aniState = _useState4[0],
      setAniState = _useState4[1];
  ...
  (0, _react.useEffect)(function () {
    var stockAlert = setTimeout(function () {
      setAlertState(false);
    }, 2000);
    return function () {
  ...
  var _useParams = (0, _reactRouterDom.useParams)(),
      data_id = _useParams.data_id;

  var matchItems = allData[targetProduct].find(function (product) {
    return product.id == data_id;
  });

  var cartQuestion = function cartQuestion() {
    var isYes = window.confirm("선택하신 상품이 장바구니에 담겼습니다.장바구니로 갈텨??");
  ...
  return /*#__PURE__*/_react.default.createElement(_reactBootstrap.Container, null, /*#__PURE__*/_react.default.createElement(_reactBootstrap.Row, null, /*#__PURE__*/_react.default.createElement(_reactBootstrap.Col, {
    ...
    src: undefined + "/assets/".concat(targetProduct, "/").concat(targetProduct, "_").concat(matchItems.id, ".jpg"),
    width: "100%"
  }))), /*#__PURE__*/_react.default.createElement(_reactBootstrap.Col, {
    md: "6"
  }, /*#__PURE__*/_react.default.createElement("div", null, /*#__PURE__*/_react.default.createElement("h4", null, matchItems.title), /*#__PURE__*/_react.default.createElement("p", null, matchItems.price, "\uFFE6")), /*#__PURE__*/_react.default.createElement("div", null, "\uAD6C\uB9E4\uC218\uB7C9 : ", detailQuan, /*#__PURE__*/_react.default.createElement("input", {
    type: "button",
    value: "+",
    onClick: onIncrease
    ...
    onClick: function onClick() {
      onAddData({
        id: matchItems.id,
        name: matchItems.title,
        price: matchItems.price,
        quan: detailQuan
      });
      cartQuestion();
    }
  }, " \uC7A5\uBC14\uAD6C\uB2C8 "), /*#__PURE__*/_react.default.createElement(_reactBootstrap.Button, {
    onClick: function onClick() {
      history.goBack();
    }
  }, "\uBAA9\uB85D\uC73C\uB85C"), alertState === true && /*#__PURE__*/_react.default.createElement("div", {
    className: "my-alert"
  }, /*#__PURE__*/_react.default.createElement("p", null, "\uB0AB \uC774\uB108\uD504 \uC7AC\uACE0")))), /*#__PURE__*/_react.default.createElement(_reactBootstrap.Nav, {
    className: "mt-5",
    variant: "tabs",
    defaultActiveKey: "0"
  ...
  }, "\uC0C1\uC138\uC815\uBCF4")), /*#__PURE__*/_react.default.createElement(_reactBootstrap.Nav.Item, null, /*#__PURE__*/_react.default.createElement(_reactBootstrap.Nav.Link, {
    eventKey: "1",
    onClick: function onClick() {
      setTap("review");
      setAniState(false);
    }
  }, "\uACE0\uAC1D\uB9AC\uBDF0")), /*#__PURE__*/_react.default.createElement(_reactBootstrap.Nav.Item, null, /*#__PURE__*/_react.default.createElement(_reactBootstrap.Nav.Link, {
    eventKey: "2",
    onClick: function onClick() {
      setTap("question");
      setAniState(false);
    }
  }, "\uBB38\uC758\uC0AC\uD56D"))), /*#__PURE__*/_react.default.createElement(_reactTransitionGroup.CSSTransition, {
    in: aniState,
    classNames: "wow",
    timeout: 500
...
function TabContent(_ref2) {
  var tap = _ref2.tap,
      setAniState = _ref2.setAniState;
  var tabUI = {
    info: /*#__PURE__*/_react.default.createElement("p", null, "\uC0C1\uC138\uC815\uBCF4"),
    review: /*#__PURE__*/_react.default.createElement("p", null, "\uACE0\uAC1D\uB9AC\uBDF0"),
    question: /*#__PURE__*/_react.default.createElement("p", null, "\uBB38\uC758\uC0AC\uD56D")
  };
  (0, _react.useEffect)(function () {
    setAniState(true);
  });
  return /*#__PURE__*/_react.default.createElement("div", null, tabUI[tap]);
}

var _default = Detail;
exports.default = _default;
},{"react":"../node_modules/react/index.js","react-router-dom":"../node_modules/react-router-dom/esm/react-router-dom.js","react-bootstrap":"../node_modules/react-bootstrap/esm/index.js","react-transition-group":"../node_modules/react-transition-group/esm/index.js"}],"../src/containers/DetailContainer.js":[function(require,module,exports) {
"use strict";
...
var _detailQuan = require("../modules/detailQuan");

var _cartQuan = require("../modules/cartQuan");

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

function DetailContainer(_ref) {
  var allData = _ref.allData,
      setAllData = _ref.setAllData,
      targetProduct = _ref.targetProduct;
  // useSelector는 리덕스 스토어의 상태를 조회하는 Hook입니다.
  // state의 값은 store.getState() 함수를 호출했을 때 나타나는 결과물과 동일합니다.
  var detailQuan = (0, _reactRedux.useSelector)(function (state) {
    return state.detailQuan;
  }); // useDispatch 는 리덕스 스토어의 dispatch 를 함수에서 사용 할 수 있게 해주는 Hook 입니다.

  var dispatch = (0, _reactRedux.useDispatch)(); // 각 액션들을 디스패치하는 함수들을 만드세요

  var onQuan_Initialize = function onQuan_Initialize() {
    return dispatch((0, _detailQuan.quan_Initialize)());
  };

  var onIncrease = function onIncrease() {
    return dispatch((0, _detailQuan.increase)());
  };

  var onDecrease = function onDecrease() {
    return dispatch((0, _detailQuan.decrease)());
  };

  var onAddData = function onAddData(data) {
    return dispatch((0, _cartQuan.addData)(data));
  }; // cartQuan에서 가져옴
...
exports.default = _default;
},{"react":"../node_modules/react/index.js","react-redux":"../node_modules/react-redux/es/index.js","../Components/Detail":"../src/Components/Detail.js","../modules/detailQuan":"../src/modules/detailQuan.js","../modules/cartQuan":"../src/modules/cartQuan.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
//# sourceMappingURL=/DetailContainer.d020ed30.js.map